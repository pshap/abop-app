...
pub mod test_colors {
    ...
    pub const MATERIAL_BLUE: Color = Color { r: 0.404, g: 0.314, b: 0.643, a: 1.0 };
    pub const MATERIAL_RED: Color = Color { r: 0.729, g: 0.071, b: 0.212, a: 1.0 };
...
pub mod test_assertions {
    ...
    pub fn assert_colors_different(color1: Color, color2: Color) {
        assert_ne!(color1, color2, "Colors should be different: {color1:?} vs {color2:?}");
    }
