...
pub mod migration {
    ...
    impl<'a> MethodBasedAdapter<'a> {
        ...
        pub fn on_primary_container(&self) -> Color {
            self.colors.primary.on_container
        } // Secondary colors
        ...
        pub fn on_secondary_container(&self) -> Color {
            self.colors.secondary.on_container
        } // Tertiary colors
