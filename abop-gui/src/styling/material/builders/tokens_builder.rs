...
//! with customizable options and flexible configuration.
...
/// with various customization options and flexible theme configuration.
...
impl MaterialTokensBuilder {
    ...
    pub fn build(self) -> MaterialTokens {
        // Build tokens based on configuration options
