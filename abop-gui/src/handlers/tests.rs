...
mod ui_state_tests {
    ...
    fn test_handle_sort_by() {
        ...
        let book1 =
            TestDataFactory::audiobook_with_path("1", TEST_TITLE_1, TEST_AUTHOR_A, TEST_BOOK1_PATH);
        let book2 =
            TestDataFactory::audiobook_with_path("2", TEST_TITLE_2, TEST_AUTHOR_B, TEST_BOOK2_PATH);
        let book3 =
            TestDataFactory::audiobook_with_path("3", TEST_TITLE_3, TEST_AUTHOR_C, TEST_BOOK3_PATH);
        ...
        state
            .library
            .audiobooks
            .push(TestDataFactory::audiobook_with_path(
                TEST_AUDIOBOOK_ID_1,
                TEST_TITLE_1,
                TEST_AUTHOR_A,
                TEST_BOOK1_PATH,
