...
//!
//! This module provides a theme provider for managing the application's theme state
//! and making it accessible throughout the component hierarchy.

use crate::material::color::{Theme, ThemeVariant};
    ...
    Message: 'static + Clone,
{
    ...
    pub fn with_variant(mut self, variant: ThemeVariant) -> Self {
        self.theme = match variant {
            ThemeVariant::Light => Arc::new(Theme::light()),
            ThemeVariant::Dark => Arc::new(Theme::dark()),
        };
        self
    }
...
/// A subscription to theme changes
