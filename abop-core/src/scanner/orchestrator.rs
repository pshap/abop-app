...
impl ScanOrchestrator {
    ...
    #[must_use] pub fn new(database: Arc<Database>, library: Library, config: ScannerConfig) -> Self {
    ...
    #[must_use] pub fn with_performance_monitor(mut self, monitor: Arc<PerformanceMonitor>) -> Self {
