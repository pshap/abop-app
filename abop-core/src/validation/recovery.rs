...
impl RepairContext {
    ...
    #[must_use] pub fn new(validation_result: &ValidationResult) -> Self {
        Self {
    ...
    #[must_use] pub fn auto_repairable_issues(&self) -> Vec<&ValidationError> {
        self.issues
            .iter()
